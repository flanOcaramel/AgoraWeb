...
final class ParticipantController extends AbstractController
{
    ...
    public function index(ParticipantRepository $participantRepository): Response
    {
        return $this->render('participant/index.html.twig', [
            'participants' => $participantRepository->findAllWithTournois(),
            'menuActif' => 'Tournois',
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, ParticipantRepository $participantRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $existingIds = $participantRepository->createQueryBuilder('p')->select('p.id')->orderBy('p.id')->getQuery()->getScalarResult();
