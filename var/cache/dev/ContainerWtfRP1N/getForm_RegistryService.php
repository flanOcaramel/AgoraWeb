...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\CatTournoisType' => ['privates', 'App\\Form\\CatTournoisType', 'getCatTournoisTypeService', true],
            'App\\Form\\GenreType' => ['privates', 'App\\Form\\GenreType', 'getGenreTypeService', true],
            'App\\Form\\JeuVideo1Type' => ['privates', 'App\\Form\\JeuVideo1Type', 'getJeuVideo1TypeService', true],
            'App\\Form\\JeuVideoType' => ['privates', 'App\\Form\\JeuVideoType', 'getJeuVideoTypeService', true],
            'App\\Form\\MarqueType' => ['privates', 'App\\Form\\MarqueType', 'getMarqueTypeService', true],
            'App\\Form\\MembreType' => ['privates', 'App\\Form\\MembreType', 'getMembreTypeService', true],
            'App\\Form\\ParticipantType' => ['privates', 'App\\Form\\ParticipantType', 'getParticipantTypeService', true],
            'App\\Form\\PegiType' => ['privates', 'App\\Form\\PegiType', 'getPegiTypeService', true],
            'App\\Form\\PlateformeType' => ['privates', 'App\\Form\\PlateformeType', 'getPlateformeTypeService', true],
            ...
            'App\\Form\\TournoiType' => ['privates', 'App\\Form\\TournoiType', 'getTournoiTypeService', true],
            ...
            'App\\Form\\CatTournoisType' => '?',
            'App\\Form\\GenreType' => '?',
            'App\\Form\\JeuVideo1Type' => '?',
            'App\\Form\\JeuVideoType' => '?',
            'App\\Form\\MarqueType' => '?',
            'App\\Form\\MembreType' => '?',
            'App\\Form\\ParticipantType' => '?',
            'App\\Form\\PegiType' => '?',
            'App\\Form\\PlateformeType' => '?',
            'App\\Form\\ProfileType' => '?',
            'App\\Form\\RegistrationType' => '?',
            'App\\Form\\TournoiType' => '?',
