...
class __TwigTemplate_21a022c8466bc918dfb175496c05cfc2 extends Template
{
    ...
    <button class=\"btn\">";
        // line 3
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("button_label", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 3, $this->source); })()), "Enregister")) : ("Enregister")), "html", null, true);
        yield "</button>
";
        // line 4
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn\">{{ button_label|default('Enregister') }}</button>
{{ form_end(form) }}
", "genre/_form.html.twig", "/var/www/html/AP/Agora/templates/genre/_form.html.twig");
    }
}
